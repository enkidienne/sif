...
/mob/living/simple_animal/hostile/megafauna/sif
	...
	attacktext = "cuts"
	attack_sound = 'sound/creatures/sif_slash.ogg'
	icon_state = "Great_Brown_Wolf"
	icon_living = "Great_Brown_Wolf"
	icon_dead = ""
	friendly = "stares down"
	icon = 'icons/mob/lavaland/sif.dmi'
	...
	deathsound = 'yogstation/sound/effects/death_howl.ogg'
...
/mob/living/simple_animal/hostile/megafauna/sif/living_beacon
	...
	icon_state = "beacon"
	icon_living = "beacon"
	icon = 'icons/mob/lavaland/beacon.dmi'
...
/obj/structure/sword/sif
	...
	max_integrity = 10000
	anchored = TRUE
	icon = 'icons/mob/lavaland/sif_sword.dmi'
...
/mob/living/simple_animal/hostile/megafauna/sif/proc/angered()
	...
	playsound(src, 'yogstation/sound/effects/howl.ogg', 100, 1)
	...
	if(can_special == 1)
		...
		if(spinning == TRUE)
			...
			if(isturf(src.loc) || isobj(src.loc) && src.loc.density)
				...
				playsound(src, pick('yogstation/sound/effects/whoosh1.ogg', 'yogstation/sound/effects/whoosh2.ogg', 'yogstation/sound/effects/whoosh3.ogg'), 300, 1)
				playsound(src, 'yogstation/sound/effects/blade_spin.ogg', 400, 1)
				if(angered)
					src.speed = 8
					src.move_to_delay = 2
...
/mob/living/simple_animal/hostile/megafauna/sif/Bump(atom/A)
	if(charging == TRUE)
		...
		if(isliving(A))
			...
			playsound(get_turf(L), 'sound/creatures/sif_stomp.ogg', 400, 1)
			shake_camera(L, 4, 3)
...
**
*/
/obj/item/twohanded/required/sword_of_the_forsaken
	...
	icon = 'yogstation/icons/obj/items_and_weapons.dmi'
	icon_state = "sword_of_the_forsaken"
	lefthand_file = 'yogstation/icons/mob/inhands/item_lefthand.dmi'
	righthand_file = 'yogstation/icons/mob/inhands/item_righthand.dmi'
	w_class = WEIGHT_CLASS_BULKY
	force = 45
	throwforce = 20
	block_chance = 60
	armour_penetration = 80
	hitsound = 'sound/creatures/sif_slash.ogg'
...
/obj/item/twohanded/required/sword_of_the_forsaken/Initialize()
	. = ..()
	AddComponent(/datum/component/butchering, 50, 100, 10)

//Sword blocking attacks,
/obj/item/twohanded/required/sword_of_the_forsaken/hit_reaction(mob/living/carbon/human/owner, atom/movable/hitby, attack_text = "the attack", final_block_chance = 0, damage = 0, attack_type = MELEE_ATTACK)
...
/obj/structure/closet/crate/necropolis/sif/PopulateContents()
	new /obj/item/twohanded/required/sword_of_the_forsaken(src)
